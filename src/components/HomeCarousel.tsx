...
const slides = [
  {
    ...
    image:
      "https://images.firstpost.com/fpimages/1200x800/fixed/jpg/2020/05/helicopter_landing_composite_crop-web-1.jpg",
  ...
  },
  {
    ...
    //   "https://res.cloudinary.com/du8n2aa4p/image/upload/v1631384658/shopify2/helixnebula-169.jpg",
    image:
      "https://mars.nasa.gov/imgs/mars2020/name-the-rover/NameTheNextMarsRover-web.jpg",
    logo: "https://res.cloudinary.com/du8n2aa4p/image/upload/v1631384602/shopify2/5ecec99f73e4440004f09e7c.png",
...
const HomeCarousel: React.FC<{}> = () => {
  ...
  const renderSlides = () => {
    return slides.map((slide, index) => {
      return (
        <Slide index={index} key={index} className={`homeCarouselContainer`}>
          <div className="backgroundContainer">
            ...
            >
              <div>
                ...
                ></img>
                <h1 className="slideDesc">{slide.description}</h1>
              </div>
            </div>
          </div>
        </Slide>
            ...
            return (
              <Dot
                ...
                children={
                  item.index === index ? (
                    <animated.div
                      className={item.stopAutoplay ? "dotFillHide" : "dotFill"}
                      style={style}
                    ></animated.div>
                  ) : (
                    ""
